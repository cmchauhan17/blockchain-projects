...
contract CarbonCredit {
    ...
    uint32 _cargoWeight) public {
        ...
        if ((keccak256(abi.encodePacked(transportationMode)) == keccak256(abi.encodePacked("air")))){
            CCValue_SP = (distanceCovered * 275)/1000;
        } else if ((keccak256(abi.encodePacked(transportationMode)) == keccak256(abi.encodePacked("rail")))){
            CCValue_SP = (distanceCovered * 144)/1000;
        } else if ((keccak256(abi.encodePacked(transportationMode)) == keccak256(abi.encodePacked("road")))){
            CCValue_SP = (distanceCovered * 368)/1000;
        }
    }
